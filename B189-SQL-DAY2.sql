...
VALUES('Betul Hanim','dev@mail.com',5000,'Java');
...
id int PRIMARY KEY,--not null,unique,baska bir tablo ile iliskindermek için kullanilacak
name varchar(50),
grade real,
register_date date	
);
...
id int,--not null,unique,baska bir tablo ile iliskindermek için kullanilacak
name varchar(50),
grade real,
register_date date,
